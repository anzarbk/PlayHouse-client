...
import { theatreEditAPI, theatreCreateAPI, getTheatreDataAPI } from '../../APIs/Theatre'; // FunctionAPI that helps to send data to backend
//Alert snackbar
...
export const TheatreDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (currentUserRole === 'theatre') {
      ...
      if (data.status === 'success') {
        setOpen(true);
        setSucess('Theatre Created successfully');
        getTheatreFromServer();
      }
    }
  };
  ...
  return (
    <div className="w-screen flex flex-col items-center py-5 mt-10">
