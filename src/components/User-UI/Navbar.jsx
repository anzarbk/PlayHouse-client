...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="flex justify-between w-full px-4 h-2  bg-[#ee1212] absolute">
          <Link to="/">
            <Logo />
          </Link>
        ...
        <div className=" w-full h-10 mt-12 bg-blue-900 flex justify-center items-center">
          <div className="hidden sm:flex items-center justify-around w-6/12 h-10">
            ...
            <p className="font-bold text-sm cursor-pointer " onClick={() => navigate('/ticket-list')}>
              TICKETS
            </p>
          </div>
            ...
            {navbar && (
              <div>
                <ul className=" grid justify-center gap-2 mt-32 ml-5 bg-[#2a3fbb] rounded-sm hover:shadow-md hover:shadow-red-600 p-4">
                  ...
                  <li className="font-bold text-sm" onClick={() => navigate('/ticket-list')}>
                    TICKETS
                  </li>
                </ul>
              </div>
