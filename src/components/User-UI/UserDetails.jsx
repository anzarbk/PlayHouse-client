...
import { profileEditAPI } from '../../APIs/Common';
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            ...
            <div className="p-10 md:col-span-2 md:mt-0">
              <ProfileImage />
              <div className="p-10 md:col-span-2 md:mt-0">
                <button className="inline-flex justify-center rounded-md bg-green-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Wallet balance : {wallet}</button>
              </div>
            </div>
          </div>
